...
class JsonParser {
	...
	public:
		/* Function(s). */
		static Parse parseEntity(sgdm::IAllocator< JsonEntity >* allocator, const std::string& json, unsigned int index); // TODO.
		...
		static Parse parseString(sgdm::IAllocator< JsonEntity >* allocator, const std::string& json, unsigned int index); // TODO.
		...
		static JsonEntity* parse(sgdm::IAllocator< JsonEntity >* allocator, const std::string& json); // Parse the specified JSON into a JSON entity with the specified allocator.
